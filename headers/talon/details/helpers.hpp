...
inline TALON_API auto format_include_directories(const std::vector<std::string_view>& includes, compilers compiler)
    -> std::string {
...
inline TALON_API auto format_force_includes(const std::vector<std::string_view>& force_includes, compilers compiler)
    -> std::string {
...
inline TALON_API auto format_library_directories(const std::vector<std::string_view>& lib_paths, compilers compiler)
    -> std::string {
...
inline TALON_API auto format_library_files(const std::vector<std::string_view>& libraries, compilers compiler)
    -> std::string {
...
inline TALON_API auto format_output_link_flags(output_mode type, compilers compiler) -> std::string {
    if (type == output_mode::dynamic_library && compiler == compilers::msvc) {
        return " /DLL";
    }
